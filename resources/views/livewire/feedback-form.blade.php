<div
    ...
    {{-- Focus moves to the confirmation in a macrotask, after Alpine has
         inserted it and made the form inert (which blurs the Send button). --}}
    x-on:feedback-sent.window="sent = true; setTimeout(() => $el.querySelector('[role=status] button')?.focus())"
>
    <x-modal name="feedback" maxWidth="lg" focusable>
        ...
        <form x-show="! sent" x-bind:inert="sent" wire:submit="send" class="p-6">
