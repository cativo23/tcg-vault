...
test('InvalidTcgdexIdException::forId strips control characters from the ID to prevent log injection', function () {
    $exception = InvalidTcgdexIdException::forId("me05-116\r\n[2026-09-14 12:00:00] production.CRITICAL: forged log entry");
